...
<body>
    <div class="container">
        <aside>
            ...
            <div class="sidebar">
                <a href="#" class="active a-form" data-value="form">
                    <span class="material-icons-sharp">grid_view </span>
                    <h3>Form</h3>
                </a>
                <a href="#" class="a-myproject" data-value="myproject">
                ...
                <form id="order-form">
                    ...
                    <div class="actual-form">
                        <div class="input-wrap">
                            ...
                            <input name="project_name" type="text" minlength="6" placeholder="Project Name" class="input-field projectName" required />
                        </div>

                        <div class="input-wrap">
                            <section id="header-container">
                                <select name="project_type" required class="dd">
                                    <option value="" disabled selected>Select Project Type</option>
                                    <option value="bot">Discord Bot</option>
                                    <option value="web">Website</option>
                                    <option value="server">FiveM Server</option>
                                </select>
                            </section>
                        </div>

                        <input type="submit" value="Add Order" class="sign-btn" id="signin-btn" />
                    </div>
                </form>
            </div>
        ...
        <!--AKHIR DARI MAIN-->
        <!--AWAL DARI CUSTOMERS-->
        <main id="myproject" style="display:none;">
            <div class="recent-orders myproject">
                <h2>My Projects</h2>
                <table>
                    <thead>
                        <tr>
